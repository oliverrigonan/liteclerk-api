    ...
    public class TrnDisbursementModelBuilder
    {
        public static void CreateTrnDisbursementModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnDisbursementDBSet>(entity =>
            {
                ...
                entity.Property(e => e.CVNumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.CVDate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
