    ...
    public class TrnStockInModelBuilder
    {
        public static void CreateTrnStockInModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnStockInDBSet>(entity =>
            {
                ...
                entity.Property(e => e.INNumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.INDate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
