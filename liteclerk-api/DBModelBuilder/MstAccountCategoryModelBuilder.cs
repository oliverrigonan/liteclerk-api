    ...
    public class MstAccountCategoryModelBuilder
    {
        public static void CreateMstAccountCategoryModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstAccountCategoryDBSet>(entity =>
            {
                ...
                entity.HasOne(f => f.CreatedByUser).WithMany(f => f.MstAccountCategories_CreatedByUser).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.UpdatedByUser).WithMany(f => f.MstAccountCategories_UpdatedByUser).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
