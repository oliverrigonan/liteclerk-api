    ...
    public class MstJobTypeModelBuilder
    {
        public static void CreateMstJobTypeModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstJobTypeDBSet>(entity =>
            {
                ...
                entity.HasOne(f => f.MstUser_CreatedByUser).WithMany(f => f.MstJobTypes_CreatedByUser).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.MstUser_UpdatedByUser).WithMany(f => f.MstJobTypes_UpdatedByUser).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
