    ...
    public class TrnReceivingReceiptModelBuilder
    {
        public static void CreateTrnReceivingReceiptModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnReceivingReceiptDBSet>(entity =>
            {
                ...
                entity.Property(e => e.RRNumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.RRDate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
