    ...
    public class TrnPurchaseOrderModelBuilder
    {
        public static void CreateTrnPurchaseOrderModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnPurchaseOrderDBSet>(entity =>
            {
                ...
                entity.Property(e => e.PONumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.PODate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
