    ...
    public class MstAccountCashFlowModelBuilder
    {
        public static void CreateMstAccountCashFlowModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstAccountCashFlowDBSet>(entity =>
            {
                ...
                entity.HasOne(f => f.CreatedByUser).WithMany(f => f.MstAccountCashFlows_CreatedByUser).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.UpdatedByUser).WithMany(f => f.MstAccountCashFlows_UpdatedByUser).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
