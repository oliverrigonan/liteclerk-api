    ...
    public class MstJobDepartmentModelBuilder
    {
        public static void CreateMstJobDepartmentModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstJobDepartmentDBset>(entity =>
            {
                ...
                entity.HasOne(f => f.MstUser_CreatedByUser).WithMany(f => f.MstJobDepartments_CreatedByUser).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.MstUser_UpdatedByUser).WithMany(f => f.MstJobDepartments_UpdatedByUser).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
