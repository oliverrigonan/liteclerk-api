    ...
    public class TrnSalesOrderModelBuilder
    {
        public static void CreateTrnSalesOrderModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnSalesOrderDBSet>(entity =>
            {
                ...
                entity.Property(e => e.SONumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.SODate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
