    ...
    public class TrnStockWithdrawalModelBuilder
    {
        public static void CreateTrnStockWithdrawalModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnStockWithdrawalDBSet>(entity =>
            {
                ...
                entity.Property(e => e.SWNumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.SWDate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
