    ...
    public class MstTermModelBuilder
    {
        public static void CreateMstTermModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstTermDBSet>(entity =>
            {
                ...
                entity.HasOne(f => f.MstUser_CreatedByUserId).WithMany(f => f.MstTerms_CreatedByUserId).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.MstUser_UpdatedByUserId).WithMany(f => f.MstTerms_UpdatedByUserId).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
