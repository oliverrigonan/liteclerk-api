    ...
    public class TrnJournalVoucherModelBuilder
    {
        public static void CreateTrnJournalVoucherModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.TrnJournalVoucherDBSet>(entity =>
            {
                ...
                entity.Property(e => e.JVNumber).HasColumnName("CRNumber").HasColumnType("nvarchar(50)").HasMaxLength(50).IsRequired();
                entity.Property(e => e.JVDate).HasColumnName("CRDate").HasColumnType("datetime").IsRequired();
