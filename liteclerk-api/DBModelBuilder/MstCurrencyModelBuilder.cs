    ...
    public class MstCurrencyModelBuilder
    {
        public static void CreateMstCurrencyModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstCurrencyDBSet>(entity =>
            {
                ...
                entity.HasOne(f => f.CreatedByUser).WithMany(f => f.MstCurrencies_CreatedByUser).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.UpdatedByUser).WithMany(f => f.MstCurrencies_UpdatedByUser).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
