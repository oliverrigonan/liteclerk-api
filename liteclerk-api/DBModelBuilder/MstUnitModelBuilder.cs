    ...
    public class MstUnitModelBuilder
    {
        public static void CreateMstUnitModel(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DBSets.MstUnitDBSet>(entity =>
            {
                ...
                entity.HasOne(f => f.MstUser_CreatedByUserId).WithMany(f => f.MstUnits_CreatedByUserId).HasForeignKey(f => f.CreatedByUserId).OnDelete(DeleteBehavior.Restrict);
                ...
                entity.HasOne(f => f.MstUser_UpdatedByUserId).WithMany(f => f.MstUnits_UpdatedByUserId).HasForeignKey(f => f.UpdatedByUserId).OnDelete(DeleteBehavior.Restrict);
