...
namespace liteclerk_api.APIControllers
{
    ...
    public class MstArticleCustomerAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetPaginatedArticleCustomerList(String column, Int32 skip, Int32 take, String keywords)
        {
            try
            {
                var articleCustomers = await (
                    from d in _dbContext.MstArticleCustomers
                    where (
                        ...
                        column == "Customer" ? d.Customer.Contains(keywords) :
                ...
                return StatusCode(200, articleCustomers.OrderByDescending(d => d.Id).Skip(skip).Take(take));
            }
            catch (Exception e)
            {
                return StatusCode(500, e.InnerException.Message);
        ...
        public async Task<ActionResult> GetPaginatedLockedArticleCustomerList(String column, Int32 skip, Int32 take, String keywords)
        {
            try
            {
                var lockedArticleCustomers = await (
                    from d in _dbContext.MstArticleCustomers
                    where d.MstArticle_ArticleId.IsLocked == true
                    && (
                        keywords == "" || String.IsNullOrEmpty(keywords) ? true :
                        column == "All" ? d.MstArticle_ArticleId.ManualCode.Contains(keywords) ||
                                          d.Customer.Contains(keywords) ||
                                          d.Address.Contains(keywords) ||
                                          d.MstTerm_TermId.Term.Contains(keywords) :
                        column == "Manual Code" ? d.MstArticle_ArticleId.ManualCode.Contains(keywords) :
                        column == "Customer" ? d.Customer.Contains(keywords) :
                        column == "Address" ? d.Address.Contains(keywords) :
                        column == "Term" ? d.MstTerm_TermId.Term.Contains(keywords) : true
                    )
                    select new DTO.MstArticleCustomerDTO
                    {
                        Id = d.Id,
                ...
                return StatusCode(200, lockedArticleCustomers.OrderByDescending(d => d.Id).Skip(skip).Take(take));
            }
            catch (Exception e)
            {
                return StatusCode(500, e.InnerException.Message);
        ...
        public async Task<ActionResult> SaveArticleCustomer(Int32 id, [FromBody] DTO.MstArticleCustomerDTO mstArticleCustomerDTO)
        {
            try
            {
                ...
                saveArticle.Article = mstArticleCustomerDTO.Customer;
                saveArticle.Particulars = mstArticleCustomerDTO.ArticleParticulars;
        ...
        public async Task<ActionResult> LockArticleCustomer(Int32 id, [FromBody] DTO.MstArticleCustomerDTO mstArticleCustomerDTO)
        {
            try
            {
                ...
                lockArticle.Article = mstArticleCustomerDTO.Customer;
                lockArticle.Particulars = mstArticleCustomerDTO.ArticleParticulars;
