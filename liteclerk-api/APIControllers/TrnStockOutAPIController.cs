...
namespace liteclerk_api.APIControllers
{
    ...
    public class TrnStockOutAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetPaginatedStockOutListByDateRanged(String startDate, String endDate, String column, Int32 skip, Int32 take, String keywords)
        {
            try
            {
                Int32 loginUserId = Convert.ToInt32(User.FindFirst(ClaimTypes.Name)?.Value);
                ...
                var stockOuts = await (
                    ...
                    && (
                        ...
                        column == "All" ? d.OTNumber.Contains(keywords) ||
                        ...
                        column == "OT No." ? d.OTNumber.Contains(keywords) :
                ...
                return StatusCode(200, stockOuts.OrderByDescending(d => d.Id).Skip(skip).Take(take));
            }
            catch (Exception e)
            {
                return StatusCode(500, e.InnerException.Message);
