...
namespace liteclerk_api.APIControllers
{
    ...
    [ApiController]
    public class RepTrialBalancePerBranchAPIController : ControllerBase
    {
        private readonly DBContext.LiteclerkDBContext _dbContext;

        public RepTrialBalancePerBranchAPIController(DBContext.LiteclerkDBContext dbContext)
        {
            _dbContext = dbContext;
        }

        [HttpGet("list/byDateRange/{startDate}/{endDate}/byCompany/{companyId}/byBranch/{branchId}")]
        public async Task<ActionResult> GetTrialBalancePerBranchList(String startDate, String endDate, Int32 companyId, Int32 branchId)
        {
            try
            {
