...
namespace liteclerk_api.APIControllers
{
    ...
    public class TrnReceivableMemoAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetPaginatedReceivableMemoListByDateRanged(String startDate, String endDate, String column, Int32 skip, Int32 take, String keywords)
        {
            try
            {
                Int32 loginUserId = Convert.ToInt32(User.FindFirst(ClaimTypes.Name)?.Value);
                ...
                var receivableMemos = await (
                    ...
                    && (
                        ...
                        column == "All" ? d.RMNumber.Contains(keywords) ||
                        ...
                        column == "RM No." ? d.RMNumber.Contains(keywords) :
                ...
                return StatusCode(200, receivableMemos.OrderByDescending(d => d.Id).Skip(skip).Take(take));
            }
            catch (Exception e)
            {
                return StatusCode(500, e.InnerException.Message);
