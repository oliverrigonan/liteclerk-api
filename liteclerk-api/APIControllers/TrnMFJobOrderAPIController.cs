                    ...
                    if (loginUserForm.CanPrint == true)
                    {
                        ...
                        for (id = 1; id <= 2; id++)
                        {
                            if (jobOrder != null)
                            {
                                ...
                                tableJobOrderFooter.AddCell(new PdfPCell(new Phrase("Units not claimed within 30 days after the repair completion notice date will be charge a storage fee of P 25.0 per day.", fontSegoeUI09)) { Border = 0, PaddingTop = 2f, PaddingBottom = 5f, PaddingLeft = 5f, PaddingRight = 5f, Colspan = 2 });
