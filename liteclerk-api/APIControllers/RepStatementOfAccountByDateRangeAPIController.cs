...
namespace liteclerk_api.APIControllers
{
    ...
    [ApiController]
    public class RepStatementOfAccountByDateRangeAPIController : ControllerBase
    {
        private readonly DBContext.LiteclerkDBContext _dbContext;

        public RepStatementOfAccountByDateRangeAPIController(DBContext.LiteclerkDBContext dbContext)
        {
            _dbContext = dbContext;
        }

        [HttpGet("print/{startDate}/{endDate}/{customerId}/{companyId}/{branchId}")]
        public async Task<ActionResult> PrintStatementOfAccountByDateRange(String startDate, String endDate, Int32 customerId, Int32 companyId, Int32 branchId)
        {
