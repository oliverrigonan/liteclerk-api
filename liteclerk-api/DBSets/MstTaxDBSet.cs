...
namespace liteclerk_api.DBSets
{
    public class MstTaxDBSet
    {
        ...
        public virtual ICollection<TrnReceivingReceiptItemDBSet> TrnReceivingReceiptItems_VATId { get; set; }
        public virtual ICollection<TrnReceivingReceiptItemDBSet> TrnReceivingReceiptItems_WTAXId { get; set; }
        ...
        public virtual ICollection<TrnDisbursementLineDBSet> TrnDisbursementLines_WTAXId { get; set; }
