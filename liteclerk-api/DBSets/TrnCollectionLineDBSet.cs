...
namespace liteclerk_api.DBSets
{
    public class TrnCollectionLineDBSet
    {
        ...
        public virtual TrnCollectionDBSet TrnCollection_Collection { get; set; }
        ...
        public virtual MstPayTypeDBSet MstPayType_PayType { get; set; }
        public String Particulars { get; set; }
        public String CheckNumber { get; set; }
        public DateTime? CheckDate { get; set; }
        public String CheckBank { get; set; }
        public Int32 BankId { get; set; }
        public virtual MstArticleDBSet MstArticle_Bank { get; set; }
