...
namespace liteclerk_api.Migrations
{
    ...
    [Migration("20200816134640_AddedTrnSalesInvoiceTable")]
    partial class AddedTrnSalesInvoiceTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstArticleAccountGroupDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "AssetAccount")
                        .WithMany("MstArticleAccountGroups_AssetAccount")
                        .HasForeignKey("AssetAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "CostAccount")
                    ...
                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "ExpenseAccount")
                        .WithMany("MstArticleAccountGroups_ExpenseAccount")
                        .HasForeignKey("ExpenseAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "SalesAccount")
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstArticleItemDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstArticleAccountGroupDBSet", "ArticleAccountGroup")
                    ...
                    b.HasOne("liteclerk_api.DBSets.MstUnitDBSet", "Unit")
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnSalesInvoiceDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "ApprovedByUser")
                        .WithMany("TrnSalesInvoices_ApprovedByUser")
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstCompanyBranchDBSet", "Branch")
                        .WithMany("TrnSalesInvoices_Branch")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "CheckedByUser")
                    ...
                    b.HasOne("liteclerk_api.DBSets.MstArticleDBSet", "Customer")
                        .WithMany("TrnSalesInvoices_Customer")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "PreparedByUser")
                        .WithMany("TrnSalesInvoices_PreparedByUser")
                        .HasForeignKey("PreparedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "SoldByUser")
