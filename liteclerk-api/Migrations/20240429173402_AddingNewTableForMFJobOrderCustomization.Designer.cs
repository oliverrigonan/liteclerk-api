...
namespace liteclerk_api.Migrations
{
    ...
    [Migration("20240429173402_AddingNewTableForMFJobOrderCustomization")]
    partial class AddingNewTableForMFJobOrderCustomization
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstCompanyDBSet", b =>
                {
                    ...
                    b.Property<int?>("ForexGainAccountId")
                        .HasColumnName("ForexGainAccountId")
                        .HasColumnType("int");

                    b.Property<int?>("ForexLossAccountId")
                        .HasColumnName("ForexLossAccountId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SalesInvoiceApprovedByUserId")
                        .HasColumnName("SalesInvoiceApprovedByUserId")
                        .HasColumnType("int");

                    b.Property<int?>("SalesInvoiceCheckedByUserId")
                        .HasColumnName("SalesInvoiceCheckedByUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ForexGainAccountId");

                    b.HasIndex("ForexLossAccountId");

                    b.HasIndex("IncomeAccountId");

                    b.HasIndex("SalesInvoiceApprovedByUserId");

                    b.HasIndex("SalesInvoiceCheckedByUserId");
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstCurrencyExchangeDBSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.SysFormTableColumnDBSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SysFormTableColumn");
                });

            modelBuilder.Entity("liteclerk_api.DBSets.SysFormTableDBSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnJobOrderDBSet", b =>
                {
                    ...
                    b.Property<string>("CurrentDepartmentStatus")
                        .HasColumnName("CurrentDepartmentStatus")
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);

                    b.Property<string>("CurrentDepartmentUserFullName")
                        .HasColumnName("CurrentDepartmentUserFullName")
                        .HasColumnType("nvarchar(255)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnMFJobOrderDBSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TrnMFJobOrder");
                });

            modelBuilder.Entity("liteclerk_api.DBSets.TrnMFJobOrderLineDBSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MFJOId")
                        .HasColumnName("MFJOId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnSalesInvoiceMFJOItemDBSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MFJOItemId")
                        .HasColumnName("MFJOItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MFJOItemId");

                    b.HasIndex("SIId");

                    b.ToTable("TrnSalesInvoiceMFJOItem");
                });
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstArticleAccountGroupDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstArticleTypeDBSet", "MstArticleType_ArticleTypeId")
                        .WithMany("MstArticleAccountGroups_ArticleTypeId")
                        .HasForeignKey("ArticleTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstCompanyDBSet", b =>
                {
                    ...
                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "MstAccount_ForexGainAccount")
                        .WithMany("MstCompanies_ForexGainAccountId")
                        .HasForeignKey("ForexGainAccountId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "MstAccount_ForexLossAccount")
                        .WithMany("MstCompanies_ForexLossAccountId")
                        .HasForeignKey("ForexLossAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_SalesInvoiceApprovedByUserId")
                        .WithMany("MstCompanies_SalesInvoiceApprovedByUserId")
                        .HasForeignKey("SalesInvoiceApprovedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_SalesInvoiceCheckedByUserId")
                        .WithMany("MstCompanies_SalesInvoiceCheckedByUserId")
                        .HasForeignKey("SalesInvoiceCheckedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstCurrencyExchangeDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstCurrencyDBSet", "MstCurrency_CurrencyId")
                        .WithMany("MstCurrencyExchanges_CurrencyId")
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstCurrencyDBSet", "MstCurrency_ExchangeCurrencyId")
                        .WithMany("MstCurrencyExchanges_ExchangeCurrencyId")
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.MstDiscountDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstAccountDBSet", "MstAccount_AccountId")
                        .WithMany("MstDiscounts_AccountId")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.SysFormTableColumnDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.SysFormTableDBSet", "SysFormTable_TableId")
                        .WithMany("SysFormTableColumns_TableId")
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnMFJobOrderDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_ApprovedByUserId")
                        .WithMany("TrnMFJobOrders_ApprovedByUserId")
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstCompanyBranchDBSet", "MstCompanyBranch_BranchId")
                        .WithMany("TrnMFJobOrders_BranchId")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_CheckedByUserId")
                        .WithMany("TrnMFJobOrder_CheckedByUserId")
                        .HasForeignKey("CheckedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_CreatedByUserId")
                        .WithMany("TrnMFJobOrders_CreatedByUserId")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstArticleDBSet", "MstArticle_CustomerId")
                        .WithMany("TrnMFJobOrders_Customer")
                        .HasForeignKey("CustomerId");

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_PreparedByUserId")
                        .WithMany("TrnMFJobOrders_PreparedByUserId")
                        .HasForeignKey("PreparedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.MstUserDBSet", "MstUser_UpdatedByUserId")
                        .WithMany("TrnMFJobOrders_UpdatedByUserId")
                        .HasForeignKey("UpdatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnMFJobOrderLineDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.TrnMFJobOrderDBSet", "TrnMFJobOrder_MFJOId")
                        .WithMany("TrnMFJobOrderLine_MFJOId")
                        .HasForeignKey("MFJOId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("liteclerk_api.DBSets.TrnSalesInvoiceMFJOItemDBSet", b =>
                {
                    b.HasOne("liteclerk_api.DBSets.TrnMFJobOrderDBSet", "TrnMFJobOrder_MFJOItemId")
                        .WithMany("TrnSalesInvoiceMFJOItem_MFJOSIId")
                        .HasForeignKey("MFJOItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liteclerk_api.DBSets.TrnSalesInvoiceDBSet", "TrnSalesInvoice_SIId")
                        .WithMany("TrnSalesInvoiceMFJOItems_SIId")
                        .HasForeignKey("SIId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
